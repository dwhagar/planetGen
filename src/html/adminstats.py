...
"""
Moved: server and database stats are now `/admin/stats` on the Flask app
(`web/admin_pages.py`), keeping `names_page`. The `db` parameter is
dropped: the Flask pages show the database from config.
...
if __name__ == "__main__":
    moved_permanently("/admin/stats", ("names_page",))
