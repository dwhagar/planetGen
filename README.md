...
**Version:** 5.32.0 &middot; [Changelog](CHANGELOG.md) &middot; [Repository](https://github.com/dwhagar/planetGen) &middot; License: [CC0 1.0 Universal](LICENSE.md)
...
`phenomenonGen.py` generates a single exotic stellar phenomenon, kept
deliberately separate from normal system generation — `systemGen.py`/
