...
This module defines global configuration flags and variables that control the
behavior of the star system generation process. These settings can be
modified via command-line arguments in `planetGen.py` or directly within
the code for specific scenarios.
"""
